...
import styles from "./SugarlandCarService.module.scss";
...
const Sugarlandcarservice = (props) => {
  ...
  // const cms = useSelector((state) => state.sugarlandLimo);
  // const { sugarland_limo_page } = cms;

  // const data =
  //   sugarland_limo_page && sugarland_limo_page.sugarlandLimoService[0];
  // const faqs = cms.sugarland_limo_page && cms.sugarland_limo_page.faqs;

  useEffect(() => {
    dispatch(getSugarlandLimoPage());
  }, []);
...
export default Sugarlandcarservice;
