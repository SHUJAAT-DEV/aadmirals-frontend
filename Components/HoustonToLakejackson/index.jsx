...
const Houstontolakejackson = (props) => {
  ...
  const fleet = HoustonToLakeJackson && HoustonToLakeJackson.fleet;
  const cityWeServe = HoustonToLakeJackson && HoustonToLakeJackson.cityWeServe;
  return (
    <>
...
export default Houstontolakejackson;
