...
import styles from "./TomballCarService.module.scss";
...
import { getTomballLimoPage } from "../../redux/Cities/Tomball_Limo_Service/action";
import { useDispatch, useSelector } from "react-redux";
import { Alert } from "reactstrap";
import { NextSeo } from "next-seo";
import Image from "next/image";
const Tomballcarservice = (props) => {
  const dispatch = useDispatch();

  // const cms = useSelector((state) => state.tomballLimo);
  // const { tomball_limo_page } = cms;

  // const data = tomball_limo_page && tomball_limo_page.tomballLimoService[0];
  // const faqs = cms.tomball_limo_page && cms.tomball_limo_page.faqs;

  useEffect(() => {
    dispatch(getTomballLimoPage());
  }, []);
...
export default Tomballcarservice;
