...
import styles from "./ConroeCarService.module.scss";
...
import { getConroeLimoPage } from "../../redux/Cities/Conroe_Limo_Service/action";
...
const Conroecarservice = (props) => {
  ...
  // const cms = useSelector((state) => state.conroeLimo);
  // const { conroe_limo_page } = cms;

  // const data = conroe_limo_page && conroe_limo_page.conroeLimoService[0];
  // const faqs = cms.conroe_limo_page && cms.conroe_limo_page.faqs;

  useEffect(() => {
    dispatch(getConroeLimoPage());
  }, []);
            ...
            <p className={styles.heading}>
              ...
              <div className={styles.aligncontent}>
                <p className={styles.text}>
                  ...
                  member, even more our online quotes and reservation system
                  already includes a 5% discounted price, so book online to save
                  money with AAdmirals Travel& Transportation, Houston Limo
                  Service.
                </p>
              </div>
              <ImageSection
...
export default Conroecarservice;
