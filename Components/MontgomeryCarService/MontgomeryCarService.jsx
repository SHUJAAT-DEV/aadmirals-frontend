...
import styles from "./MontgomeryCarService.module.scss";
...
const Montgomerycarservice = (props) => {
  ...
  // const cms = useSelector((state) => state.montgomeryLimo);
  ...
  useEffect(() => {
    dispatch(getMontgomeryLimoPage());
  }, []);
...
export default Montgomerycarservice;
