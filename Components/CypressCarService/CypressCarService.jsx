...
import styles from "./CypressCarService.module.scss";
...
const Cypresscarservice = (props) => {
  ...
  // const cms = useSelector((state) => state.cypressLimo);
  // const { cypress_limo_page } = cms;
                ...
                <Col xs={12}>
                  <div className={styles.aligncenter}>
                    <p className={styles.headtext}>
                      ...
                      Transportation Service In Cypress, TX And The Houston
                      Greater Area
                    </p>
                  </div>
                </Col>
...
export default Cypresscarservice;
