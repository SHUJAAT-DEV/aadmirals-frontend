...
function PrivateJetLimoServicePage() {
  const router = useRouter();
  const {serviceContent ,isLoading, isError,error}= useService("64019cd889f32d0dc477299a")
  return (
    <>
      <NextSeo
...
export async function getStaticProps({ query }) {
  ...
  await queryClient.prefetchQuery(['service-page', "64019cd889f32d0dc477299a"], getServiceContentById("64019cd889f32d0dc477299a"))
  return {
    props: {
