...
function BachelorettePartyPage() {
  const router = useRouter();
  const {serviceContent ,isLoading, isError,error}= useService("64019e7f89f32d0dc4772a4e")
  return (
    <>
      <NextSeo
...
export async function getStaticProps({ query }) {
  ...
  await queryClient.prefetchQuery(['service-page', "64019e7f89f32d0dc4772a4e"], getServiceContentById("64019e7f89f32d0dc4772a4e"))
  return {
    props: {
