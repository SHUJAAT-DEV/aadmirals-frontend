...
function BusinessconventionsmeetingsPage() {
  const router = useRouter();
  const {serviceContent ,isLoading, isError,error}= useService("64019de689f32d0dc4772a04")
  return (
    <>
      <NextSeo
...
export async function getStaticProps({ query }) {
  ...
  await queryClient.prefetchQuery(['service-page', "64019de689f32d0dc4772a04"], getServiceContentById("64019de689f32d0dc4772a04"))
  return {
    props: {
