...
function Events() {
  ...
  const {serviceContent ,isLoading, isError,error}= useService("640c6a8e4719540d93c3d76d")
  return (
    <>
      <NextSeo
...
export async function getStaticProps({ query }) {
  ...
  await queryClient.prefetchQuery(['service-page', "640c6a8e4719540d93c3d76d"], getServiceContentById("640c6a8e4719540d93c3d76d"))
  return {
    props: {
