...
function ConcertcontentstructurePage() {
  const router = useRouter();
  const {serviceContent ,isLoading, isError,error}= useService("64019e1689f32d0dc4772a24")
  return (
    <>
      <NextSeo
...
export async function getStaticProps({ query }) {
  ...
  await queryClient.prefetchQuery(['service-page', "64019e1689f32d0dc4772a24"], getServiceContentById("64019e1689f32d0dc4772a24"))
  return {
    props: {
