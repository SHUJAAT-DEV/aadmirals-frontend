...
function AstrogamePage() {
  ...
  const {serviceContent ,isLoading, isError,error}= useService("64019e0189f32d0dc4772a22")
  return (
    <>
      <NextSeo
...
export async function getStaticProps({ query }) {
  ...
  await queryClient.prefetchQuery(['service-page', "64019e0189f32d0dc4772a22"], getServiceContentById("64019e0189f32d0dc4772a22"))
  return {
    props: {
