...
function HoustontoDallasTransferPage() {
  const router = useRouter();
  const {serviceContent ,isLoading, isError,error}= useService("64019d7089f32d0dc47729ce")
  return (
    <>
      <NextSeo
...
export async function getStaticProps({ query }) {
  ...
  await queryClient.prefetchQuery(['service-page', "64019d7089f32d0dc47729ce"], getServiceContentById("64019d7089f32d0dc47729ce"))
  return {
    props: {
