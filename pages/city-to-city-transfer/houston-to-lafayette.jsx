...
function HoustontoLafayetteTransferPage() {
  const router = useRouter();
  const {serviceContent ,isLoading, isError,error}= useService("64019dd189f32d0dc4772a02")
  return (
    <>
      <NextSeo
...
export async function getStaticProps({ query }) {
  ...
  await queryClient.prefetchQuery(['service-page', "64019dd189f32d0dc4772a02"], getServiceContentById("64019dd189f32d0dc4772a02"))
  return {
    props: {
