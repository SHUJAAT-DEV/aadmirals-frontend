...
function HoustonToLakeJacksonPage() {
  ...
  const {serviceContent ,isLoading, isError,error}= useService("64019d2789f32d0dc47729b8")
  return (
    <>
      <NextSeo
...
export async function getStaticProps({ query }) {
  ...
  await queryClient.prefetchQuery(['service-page', "64019d2789f32d0dc47729b8"], getServiceContentById("64019d2789f32d0dc47729b8"))
  return {
    props: {
