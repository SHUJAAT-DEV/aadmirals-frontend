...
function Houston_to_CollegeStatTransferPage() {
  const router = useRouter();
  const {serviceContent ,isLoading, isError,error}= useService("64019cfd89f32d0dc47729a6")
  return (
    <>
      <NextSeo
...
export async function getStaticProps({ query }) {
  ...
  await queryClient.prefetchQuery(['service-page', "64019cfd89f32d0dc47729a6"], getServiceContentById("64019cfd89f32d0dc47729a6"))
  return {
    props: {
