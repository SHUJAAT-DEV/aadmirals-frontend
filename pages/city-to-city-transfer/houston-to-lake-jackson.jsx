...
function HoustonToLakeJacksonPage() {
  const router = useRouter();
  const {serviceContent ,isLoading, isError,error}= useService("64019d1489f32d0dc47729a8")
  return (
    <>
      <NextSeo
...
export async function getStaticProps({ query }) {
  ...
  await queryClient.prefetchQuery(['service-page', "64019d1489f32d0dc47729a8"], getServiceContentById("64019d1489f32d0dc47729a8"))
  return {
    props: {
