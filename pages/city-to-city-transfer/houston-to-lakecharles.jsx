...
function HoustontoLakeCharlesTransferPage() {
  const router = useRouter();
  const {serviceContent ,isLoading, isError,error}= useService("64019da589f32d0dc47729e8")
  return (
    <>
      <NextSeo
...
export async function getStaticProps({ query }) {
  ...
  await queryClient.prefetchQuery(['service-page', "64019da589f32d0dc47729e8"], getServiceContentById("64019da589f32d0dc47729e8"))
  return {
    props: {
